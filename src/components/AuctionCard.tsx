  ...
  return (
    ...
    >
      <div className="relative overflow-hidden bg-card rounded-sm">
        {/* Image */}
        <div className={`${heightClass} relative overflow-hidden bg-muted`}>
          <Image
            src={imageUrl}
            alt={auction.title}
            fill
          ...
          {/* Overlay Gradient */}
          <div className="absolute inset-0 bg-gradient-to-t from-background/95 via-background/40 to-transparent opacity-80 group-hover:opacity-60 transition-opacity duration-700 ease-in-out" />
